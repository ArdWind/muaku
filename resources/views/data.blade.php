            ...
            <div class="card-body">
              <table id="tabel1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>
                    <a href="{{ route('data_users.edit', $user->id) }}" class="btn btn-sm btn-warning" title="Edit">
                      <i class="fas fa-edit"></i>
                    </a>
                    <form action="{{ route('data_users.destroy', $user->id) }}" method="POST" style="display:inline-block;">
                      @csrf
                      @method('DELETE')
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <img src="{{ asset($product->product_img) }}" alt="Product Image" width="50">
                        @endif
                      </td>
                      ...
                      <td>
                        <a href="{{ route('data_products.edit', $product->id) }}" class="btn btn-sm btn-warning" title="Edit">
                          <i class="fas fa-edit"></i>
                        </a>
                        <form action="{{ route('data_products.destroy', $product->id) }}" method="POST" style="display:inline-block;">
                          @csrf
                          @method('DELETE')
...
<script>
  $(function () {
    ...
    createDataTableWithAddButton('#tabel1', "{{ route('data_users.create') }}", 'Add New User');
