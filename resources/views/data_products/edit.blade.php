            ...
            <div class="container-fluid d-flex justify-content-center">
                <div class="col-md-8">
                    <div class="card card-primary shadow">
                        ...
                        <form action="{{ route('data_products.update', $product->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($product->product_img)
                                        <img src="{{ asset($product->product_img) }}" alt="Gambar Produk" width="100"
                                            class="mb-2">
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="Status" class="form-control">
                                        <option value="101" {{ $product->Status == 101 ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="102" {{ $product->Status == 102 ? 'selected' : '' }}>Inactive
                                        </option>
                                        <option value="103" {{ $product->Status == 103 ? 'selected' : '' }}>Out of Stock
                                        </option>
                                        <option value="104" {{ $product->Status == 104 ? 'selected' : '' }}>Archived
                                        </option>
                                        <option value="105" {{ $product->Status == 105 ? 'selected' : '' }}>Draft
                                        </option>
                                    </select>
                                </div>
